    ...
    <Row classname='my-5 justify-content-center'>
      <Col xs={12} md={10} lg={8}>
        ...
        <div className='mt-5'>
          ...
          <Form.Control name='contents' value={contents} onChange={onChangeForm} as='textarea' rows={10} placeholder='내용을 입력하세요!'></Form.Control>
          <div className='text-center mt-3'>
            <Button onClick={onClickUpdate} variant='outline-warning' className='px-5 me-2'>수정</Button>
